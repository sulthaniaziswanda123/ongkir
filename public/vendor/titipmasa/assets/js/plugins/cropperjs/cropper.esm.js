...
var preview = {
  initPreview: function initPreview() {
    ...
    forEach(previews, function (el) {
      ...
      img.src = url;
      /**
       * Override storage element styles
...
function () {
  ...
  function Cropper(element) {
    ...
    if (!element || !REGEXP_TAG_NAME.test(element.tagName)) {
      throw new Error('The first argument is required and must be an <storage> or <canvas> element.');
    }
  ...
  _createClass(Cropper, [{
    ...
    value: function init() {
      ...
      if (tagName === 'img') {
        this.isImg = true; // e.g.: "storage/picture.jpg"
