...
@section('content')
    @php if($lat == -6.54 && $lon == 107.08) {$destination['city_name'] = 'Bekasi'; $destination['city_id'] = 54; } @endphp
    ...
    <main id="main-container">
        <div class="container mt-50">
            <h3 class="text-center mb-5">Tarif Kiriman Donasi Gempa</h3>
            <div class="row">
                <div class="col-md-5">
